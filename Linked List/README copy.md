# Python Linked Lists
Linked List exercises and test suite.

The purpose of this codealong is to implement a Linked List

- [ ] Run Test
```zsh
python3 -m unittest linkedlist-test.py
```
